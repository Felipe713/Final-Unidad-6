...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.ALWAYS)) // Control de sesiones
                .authorizeHttpRequests(http -> {
                    http.requestMatchers("/auth/**").permitAll(); // Permitir rutas públicas bajo "/auth/**"
